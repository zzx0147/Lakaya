...
// 	InteractingPawn = nullptr;
//
// 	auto const OccupationPlayerState = Cast<ALakayaBasePlayerState>(Caller->GetController()->PlayerState);
// 	if (OccupationPlayerState == nullptr)
// 	{
// 		UE_LOG(LogTemp, Warning, TEXT("OccupationObject_OccupationPlayerState is null."));
// 		return;
...
//
// 	FString const PlayerStateString = UEnum::GetValueAsString(OccupationPlayerState->GetTeam());
