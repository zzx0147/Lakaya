...
#include "UI/TabOccupationMinimapWidget.h"

#include "Character/LakayaBaseCharacter.h"
#include "Components/CanvasPanelSlot.h"

void UTabOccupationMinimapWidget::NativeConstruct()
{
...
void UTabOccupationMinimapWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
	Super::NativeTick(MyGeometry, InDeltaTime);
}

void UTabOccupationMinimapWidget::UpdatePlayerPosition(const ETeam& Team)
{
...
void UTabOccupationMinimapWidget::SetEnemyImage() const
{
...
void UTabOccupationMinimapWidget::UpdatePlayerPosition(const ETeam& NewTeam,
...
#pragma endregion
	...
	const FVector2D NewPlayerPosition = const_cast<UTabOccupationMinimapWidget*>(this)->ConvertWorldToMiniMapCoordinates(PlayerPosition, MinimapSize);
...
void UTabOccupationMinimapWidget::HidePlayerPosition(const ETeam& NewTeam,
	const TWeakObjectPtr<ALakayaBasePlayerState> NewPlayerState)
{
	if (const TWeakObjectPtr<ALakayaBasePlayerState> WeakNewPlayerState = NewPlayerState; !PlayersByMinimap[NewTeam].Contains(WeakNewPlayerState))
	{
...
UImage* UTabOccupationMinimapWidget::CreatePlayerImage(const ETeam& NewTeam, const bool bMyPlayer)
{
...
FVector2D UTabOccupationMinimapWidget::ConvertWorldToMiniMapCoordinates(const FVector2D& PlayerLocation,
